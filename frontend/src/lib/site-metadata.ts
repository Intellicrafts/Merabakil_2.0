...
export const rootMetadata: Metadata = {
  ...
  title: {
    default: `${SITE.name} — AI Legal Assistant & Advocate Marketplace India`,
  ...
  openGraph: {
    ...
    description: "Get instant legal guidance from Saarthi AI. Find verified advocates. Resolve legal issues with expert guidance grounded in Indian law.",
    url: "/",
    siteName: SITE.name,
    locale: SITE.locale,
    type: "website",
    images: [{ url: SITE.ogImage, width: 1200, height: 630, alt: "MeraBakil - India's Legal AI Platform" }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE.name} — AI Legal Assistant & Advocate Marketplace`,
