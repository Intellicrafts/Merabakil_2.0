...
export async function proposeCourtroomActions(
  ...
  const data = await apiFetch(`${researchServiceUrl()}/api/v1/research/courtroom/actions`, {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify({
      ...payload,
...
export async function runCourtroomTurn(
  ...
  const data = await apiFetch(`${researchServiceUrl()}/api/v1/research/courtroom/turn`, {
    method: "POST",
    headers: authHeaders(),
...
export async function runCourtroomAgentTurn(
  ...
  const data = await apiFetch(`${researchServiceUrl()}/api/v1/research/courtroom/agent-turn`, {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
    signal: options?.signal,
