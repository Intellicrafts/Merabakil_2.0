  ...
  if (!lastCounsel) {
    return (
      ...
      >
        ...
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-black/[0.08] text-muted-foreground dark:border-white/[0.08]">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "transition-transform duration-200 hover:-translate-y-px active:scale-[0.97]",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/15 focus-visible:ring-offset-2",
      )}
      style={{ animationDelay: "80ms" }}
    >
      <div className="flex min-w-0 items-start gap-3.5">
        <span className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-black/[0.04] text-foreground/75 dark:bg-white/[0.08]">
      ...
      <span className="mp-btn-accent inline-flex h-11 shrink-0 rounded-full px-4 text-[13px] font-semibold max-sm:w-full">
        Resume
