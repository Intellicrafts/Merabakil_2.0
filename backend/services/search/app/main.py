"""Search Service ASGI application."""
...
async def lifespan(_: FastAPI):
    try:
        ...
        logger.exception("search_startup_partial_failure")
    yield
    await container.shutdown()


app = FastAPI(
    title="AI Legal OS - Search Service",
    version="0.1.0",
    description="Vector, keyword and hybrid (RRF) search with re-ranking.",
    lifespan=lifespan,
)
